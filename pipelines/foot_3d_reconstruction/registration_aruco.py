...
@ debug_separator
def calc_trajectory_by_aruco(dir_input, df_corners_regst, K, size_chessboard, size_img, M_rltv, name_color_std="color_01", len_chessboard=0.02, dist=np.zeros(5), debug=False, dir_debug=None):        
...
def main(dir_calib_root, dir_fit_root, size_chessboard, colors, sub_corner=False, name_color_std="color_01", debug=False):
    ...
    [df_traj, df_pts3d] = calc_trajectory_by_aruco(dir_input=dir_raw, df_corners_regst=df_pts2d_regst, K=K, M_rltv=Ms_rltv[0], name_color_std=name_color_std, size_chessboard=size_chessboard, size_img=size_img, debug=debug, dir_debug=dir_debug)
...
if __name__ == '__main__':
    ...
    main(dir_calib_root, dir_input, size_chessboard,  sub_corner=True, colors=colors, name_color_std="color_02", debug=500)